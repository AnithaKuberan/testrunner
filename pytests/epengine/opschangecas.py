...
from ep_mc_bin_client import MemcachedError
...
class OpsChangeCasTests(BucketConfig):
    ...
    def test_cas_setMeta_lower(self):
        ...
        while k<10:
            ...
            set_with_meta_resp = mc_active.setWithMeta(key, '123456789', 0, 0, 123, cas, 0)
            ...
            set_with_meta_resp = mc_active.setWithMeta(key, '123456789', 0, 0, 225, max_cas+1, 0)
